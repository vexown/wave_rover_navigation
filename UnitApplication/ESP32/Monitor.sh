...
# 5. Displays the serial output from the device
...
read -p "Select the port number to monitor: " port_choice
...
# Set up ESP-IDF environment and monitor
cd "$ESP_IDF_DIR"
. ./export.sh
cd ../../ESP32/Application

echo "Monitoring $selected_port..."
